...
# DEBUG = 1
# SECRET_KEY = 'django-insecure-7#2h8z5=&hni2-w^@^6h)n^#_@mr&zm8goh*p9o%0#gnp^b=_u'
...
if USE_DOCKER:
    # Настройки базы данных для Docker (PostgreSQL)
    DATABASES = {
        'default': {
    ...
    # Настройки базы данных для локальной разработки (SQLite)
    DATABASES = {
        'default': {
